...
StripeCheckout.require.define({
  "lib/optionParser": function(exports, require, module) {
      (function() {
          var CHECKOUT_DOCS_URL, _trackIndividual, extractValue, formatMessage, helpers, isLiveModeFromKey, optionSpecs, optionValidator, trackError, trackSummary, trackWarning, tracker;
          ...
          module.exports = {
              ...
              checkUsage: function(origin, rawOptions, isDarkMode) {
                  var OPTIONS, error, errors, i, isConfigure, isLiveMode, j, len, len1, numErrors, numWarnings, quiet, ref, warning, warnings;
                  if (isDarkMode == null) {
                      isDarkMode = false
                  }
  ...
  "lib/pixel": function(exports, require, module) {
      (function() {
          ...
          track = function(event, params, callback) {
              ...
              request_params = {
                  event: event,
                  rf: redactSensitiveParams(document.referrer),
                  sc: redactSensitiveParams(window.location.search)
              };
              for (k in params) {
                  v = params[k];
...
StripeCheckout.require.define({
  "lib/tracker": function(exports, require, module) {
      (function() {
          var base64, config, helpers, isEventNameExisting, pixel, stateParameters, trace, traceSerialize, track, tracker, uuid, indexOf = [].indexOf || function(item) {
              for (var i = 0, l = this.length; i < l; i++) {
                  if (i in this && this[i] === item) return i
              }
              return -1
...
StripeCheckout.require.define({
  "outer/lib/fallbackRpc": function(exports, require, module) {
      (function() {
          var FallbackRPC, cacheBust, interval, lastHash, re, bind = function(fn, me) {
              return function() {
                  return fn.apply(me, arguments)
              }
          };
          ...
          FallbackRPC = function() {
              function FallbackRPC(target, host) {
                  this.invokeTarget = bind(this.invokeTarget, this);
                  this.target = target;
                  this.host = host
              }
...
StripeCheckout.require.define({
  "outer/controllers/app": function(exports, require, module) {
      (function() {
          var App, Checkout, RPC, TokenCallback, optionParser, tracker, utils, bind = function(fn, me) {
              return function() {
                  return fn.apply(me, arguments)
              }
          };
...
StripeCheckout.require.define({
  "outer/controllers/checkout": function(exports, require, module) {
      (function() {
          var Checkout, FallbackView, IframeView, TabView, helpers, tracker, bind = function(fn, me) {
              return function() {
                  return fn.apply(me, arguments)
              }
          };
          ...
          Checkout = function() {
              ...
              function Checkout(tokenCallback, options, configOptions) {
                  this.shouldUseManhattan = bind(this.shouldUseManhattan, this);
                  ...
                  path = function() {
                      switch (false) {
                          case viewClass !== FallbackView:
                              return "/v3/fallback/71sl3C5Gbc2BjdxBzCj6dA.html";
                          case !useManhattan:
                              return "/m/v3/index-7f66c3d8addf7af4ffc48af15300432a.html";
                          default:
                              return "/v3/gbJaAmSuOBmh95vETPnQ.html"
                      }
                  }();
                  ...
                  cb = function(_this) {
                      return function() {
                          ...
                          iframeFallback = function() {
                              ...
                              _this.view = new IframeView(_this.onToken, _this.host, "/v3/gbJaAmSuOBmh95vETPnQ.html");
...
StripeCheckout.require.define({
  "outer/views/fallbackView": function(exports, require, module) {
      (function() {
          var FallbackRPC, FallbackView, View, bind = function(fn, me) {
                  return function() {
                      return fn.apply(me, arguments)
                  }
              },
          ...
          FallbackView = function(superClass) {
              extend(FallbackView, superClass);
              ...
              FallbackView.prototype.close = function() {
                  var ref;
                  return (ref = this.frame) != null ? ref.close() : void 0
              };
...
(function() {
  ...
  if (((ref = this.StripeCheckout) != null ? ref.__app : void 0) == null) {
      ...
      if (((ref1 = this.StripeCheckout) != null ? ref1.__forceManhattan : void 0) != null) {
          app.setForceManhattan(this.StripeCheckout.__forceManhattan)
      }
      if (((ref2 = this.StripeCheckout) != null ? ref2.__forceView : void 0) != null) {
          app.setForceView(this.StripeCheckout.__forceView)
      }
      if (((ref3 = this.StripeCheckout) != null ? ref3.__forceAppType : void 0) != null) {
          app.setForceAppType(this.StripeCheckout.__forceAppType)
      }
      if (((ref4 = this.StripeCheckout) != null ? ref4.__host : void 0) && this.StripeCheckout.__host !== "") {
